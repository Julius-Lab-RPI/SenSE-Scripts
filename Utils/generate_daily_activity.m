function [t, a] = generate_daily_activity(t_on, t_off, switch_high, ...
...
%
% Description:
% Generates a single day of activity from t = [00:00 - 23:59] based on the
% method for generating light from:
...
a = a_low + ((a_high - a_low)/2)*(tanh(c*(t - switch_high)) - ...
            tanh(c*(t - switch_low)));
